...
HD_PWD='C:/Users/SER/Desktop/T2K/mPMT/MAIN_ACQ_ZYNQ _v4_UART_ACQ/MAIN_ACQ/MAIN_ACQ.runs/FIFO_DATA_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FIFO_DATA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FIFO_DATA.tcl
