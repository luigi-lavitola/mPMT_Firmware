...
HD_PWD='D:/LAVORO/Istituto Nazionale di Fisica Nucleare/Alfonso Boiano - T2K/Xilinx/mPMT/MAIN_ACQ-DEVEL/MAIN_ACQ_ZYNQ_v6_BUG_fixing/MAIN_ACQ/MAIN_ACQ.runs/TOP_block_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_block_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TOP_block_xbar_0.tcl
