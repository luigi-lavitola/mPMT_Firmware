...
/* synthesis syn_black_box black_box_pad_pin="clk,rst,din[127:0],wr_en,rd_en,dout[31:0],full,empty,valid,wr_data_count[13:0],prog_full,wr_rst_busy,rd_rst_busy" */;
  input clk;
  input rst;
  input [127:0]din;
  input wr_en;
