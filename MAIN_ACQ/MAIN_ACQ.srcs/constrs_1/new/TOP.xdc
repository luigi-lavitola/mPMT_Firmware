...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {inst_MULTYCHANNEL/pp1[2].Inst_single_channel/IBUFDS_IBUFDISABLE_inst/o}]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {inst_MULTYCHANNEL/pp1[3].Inst_single_channel/IBUFDS_IBUFDISABLE_inst/o}]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {inst_MULTYCHANNEL/pp1[4].Inst_single_channel/IBUFDS_IBUFDISABLE_inst/o}]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {inst_MULTYCHANNEL/pp1[5].Inst_single_channel/IBUFDS_IBUFDISABLE_inst/o}]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {inst_MULTYCHANNEL/pp1[6].Inst_single_channel/IBUFDS_IBUFDISABLE_inst/o}]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {inst_MULTYCHANNEL/pp1[7].Inst_single_channel/IBUFDS_IBUFDISABLE_inst/o}]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {inst_MULTYCHANNEL/pp1[8].Inst_single_channel/IBUFDS_IBUFDISABLE_inst/o}]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {inst_MULTYCHANNEL/pp1[9].Inst_single_channel/IBUFDS_IBUFDISABLE_inst/o}]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {inst_MULTYCHANNEL/pp1[10].Inst_single_channel/IBUFDS_IBUFDISABLE_inst/o}]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {inst_MULTYCHANNEL/pp1[11].Inst_single_channel/IBUFDS_IBUFDISABLE_inst/o}]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {inst_MULTYCHANNEL/pp1[12].Inst_single_channel/IBUFDS_IBUFDISABLE_inst/o}]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {inst_MULTYCHANNEL/pp1[13].Inst_single_channel/IBUFDS_IBUFDISABLE_inst/o}]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {inst_MULTYCHANNEL/pp1[14].Inst_single_channel/IBUFDS_IBUFDISABLE_inst/o}]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {inst_MULTYCHANNEL/pp1[15].Inst_single_channel/IBUFDS_IBUFDISABLE_inst/o}]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {inst_MULTYCHANNEL/pp1[16].Inst_single_channel/IBUFDS_IBUFDISABLE_inst/o}]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {inst_MULTYCHANNEL/pp1[17].Inst_single_channel/IBUFDS_IBUFDISABLE_inst/o}]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {inst_MULTYCHANNEL/pp1[18].Inst_single_channel/IBUFDS_IBUFDISABLE_inst/o}]
...
#set_clock_groups -logically_exclusive -group CLK_IN_Cavo -group CLK_IN_Cavo_2 -group FCLK_25


#set_multicycle_path -setup -from [get_clocks -of_objects [get_pins multiphase_clock/inst/mmcm_adv_inst/CLKOUT0]] -to [get_clocks -of_objects [get_pins multiphase_clock/inst/mmcm_adv_inst/CLKOUT0]] 3
set_disable_timing [get_cells Inst_Pulser/PULSER_OUT_reg]
...
create_generated_clock -name CLK_25_OUT -source [get_pins ODDR_inst/C] -divide_by 1 [get_ports CLK_25_OUT]
