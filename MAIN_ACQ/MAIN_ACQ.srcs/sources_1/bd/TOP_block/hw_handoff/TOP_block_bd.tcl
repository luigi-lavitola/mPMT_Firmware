...
proc create_root_design { parentCell } {
  ...
  set uart_Sama_boot [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:uart_rtl:1.0 uart_Sama_boot ]
  ...
  set FCLK_50 [ create_bd_port -dir O -type clk FCLK_50 ]
  set_property -dict [ list \
  ...
  set date_in_0 [ create_bd_port -dir I -from 31 -to 0 date_in_0 ]
  set hash_in_0 [ create_bd_port -dir I -from 31 -to 0 hash_in_0 ]
  ...
  set time_in_0 [ create_bd_port -dir I -from 31 -to 0 time_in_0 ]
  set version_in_0 [ create_bd_port -dir I -from 31 -to 0 version_in_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_MIO_TREE_PERIPHERALS {GPIO#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#GPIO#GPIO#GPIO#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#UART 0#UART 0#GPIO#ENET Reset#I2C 0#I2C 0#Enet 0#Enet 0} \
   CONFIG.PCW_MIO_TREE_SIGNALS {gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#gpio[8]#gpio[9]#data[0]#cmd#clk#data[1]#data[2]#data[3]#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#gpio[28]#gpio[29]#gpio[30]#gpio[31]#gpio[32]#gpio[33]#gpio[34]#gpio[35]#gpio[36]#gpio[37]#gpio[38]#gpio[39]#gpio[40]#gpio[41]#gpio[42]#gpio[43]#gpio[44]#gpio[45]#rx#tx#gpio[48]#reset#scl#sda#mdc#mdio} \
  ...
  # Create instance: version_ip_v1_0_0, and set properties
  set block_name version_ip_v1_0
  set block_cell_name version_ip_v1_0_0
  if { [catch {set version_ip_v1_0_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $version_ip_v1_0_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create interface connections
  connect_bd_intf_net -intf_net AXI_STR_RXD_0_1 [get_bd_intf_ports AXI_STR_RXD_0] [get_bd_intf_pins axis_data_fifo_0/S_AXIS]
  ...
  connect_bd_intf_net -intf_net axi_uartlite_1_UART [get_bd_intf_ports uart_Sama_boot] [get_bd_intf_pins axi_uartlite_1/UART]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins ps7_0_axi_periph/M03_AXI] [get_bd_intf_pins version_ip_v1_0_0/s_axi]

  # Create port connections
  connect_bd_net -net CLK_200_main_1 [get_bd_ports CLK_200_main] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_uartlite_1/s_axi_aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_200M/slowest_sync_clk] [get_bd_pins version_ip_v1_0_0/s_axi_aclk]
  ...
  connect_bd_net -net date_in_0_1 [get_bd_ports date_in_0] [get_bd_pins version_ip_v1_0_0/date_in]
  connect_bd_net -net hash_in_0_1 [get_bd_ports hash_in_0] [get_bd_pins version_ip_v1_0_0/hash_in]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_ports FCLK_50] [get_bd_pins processing_system7_0/FCLK_CLK1]
  connect_bd_net -net processing_system7_0_FCLK_CLK2 [get_bd_ports FCLK_25] [get_bd_pins processing_system7_0/FCLK_CLK2]
  ...
  connect_bd_net -net rst_ps7_0_200M_peripheral_aresetn [get_bd_ports peripheral_aresetn] [get_bd_ports peripheral_aresetn_0] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_uartlite_1/s_axi_aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_200M/peripheral_aresetn] [get_bd_pins version_ip_v1_0_0/s_axi_aresetn]
  connect_bd_net -net time_in_0_1 [get_bd_ports time_in_0] [get_bd_pins version_ip_v1_0_0/time_in]
  connect_bd_net -net version_in_0_1 [get_bd_ports version_in_0] [get_bd_pins version_ip_v1_0_0/version_in]
  ...
  assign_bd_address -offset 0x43D00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs M00_AXI_0/Reg] -force
  ...
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs version_ip_v1_0_0/s_axi/reg0] -force
