...
#
# Generated by Vivado on Tue Jan 18 13:43:41 +0100 2022
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fifo_generator_1 xil_defaultlib.fifo_generator_1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fifo_generator_1 -key {Behavioral:sim_1:Functional:fifo_generator_1} -tclbatch cmd.tcl -protoinst "protoinst_files/TOP_block.protoinst" -log simulate.log
}
