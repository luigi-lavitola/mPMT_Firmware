...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_13 -L axi_lite_ipif_v3_0_4 -L lib_pkg_v1_0_2 -L lib_srl_fifo_v1_0_2 -L axi_uartlite_v2_0_24 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot TOP_block xil_defaultlib.TOP_block xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim TOP_block -key {Behavioral:sim_1:Functional:TOP_block} -tclbatch cmd.tcl -protoinst "protoinst_files/TOP_block.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb TOP_block.wdb xsim.dir)
