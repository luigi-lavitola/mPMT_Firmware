...
#
# Generated by Vivado on Mon Jan 10 16:53:03 +0100 2022
...
# Script info
echo -e "FIFO_DATA.sh - Script generated by export_simulation (Vivado v2019.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot FIFO_DATA xil_defaultlib.FIFO_DATA xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim FIFO_DATA -key {Behavioral:sim_1:Functional:FIFO_DATA} -tclbatch cmd.tcl -protoinst "protoinst_files/TOP_block.protoinst" -log simulate.log
}
